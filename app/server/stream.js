...
var downloadTorrent = function(magnet)
{
...
var streamMovie = function(data, query, range_string, res)
{
    console.log("DATA = ");
    console.log(data);
    /*
...
exports.torrent = function (req, res, next)
{
    ...
    downloadTorrent(magnet).then(
        /* Promise fulfill callback */
        function(data) {
            // Neccessary for streaming video
            streamMovie(data, req.query, range_string, res);
        },
        function(err) {
...
var setHeaderInfo = function (data, info, res)
{
    ...
    header = {
        ...
        "Content-Disposition": "inline; filename=" + info.path + ";",
        "Accept-Ranges": "bytes"
    };
